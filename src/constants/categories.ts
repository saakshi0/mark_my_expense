...
export const CATEGORIES = [
  { id: 'food', name: 'Food & Dining', icon: 'restaurant', color: '#89ff6bff' },
  { id: 'emi', name: 'EMI & Loans', icon: 'credit-card', color: '#FF6B6B' },
  { id: 'transport', name: 'Travel', icon: 'car', color: '#4ECDC4' },
  ...
  { id: 'gadgets', name: 'Gadgets', icon: 'laptop', color: '#6692acff' },
